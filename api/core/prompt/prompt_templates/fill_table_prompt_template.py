...
待填字段详情：
{
    <output>:<node>vacation-requirement:<prop>name.<type>type: "文本"
    <output>:<node>vacation-requirement:<prop>sex.<type>type: "文本"
    <output>:<node>vacation-requirement:<edge>vacation.<prop>vacation_type.<type>type: "单选"
    <output>:<node>vacation-requirement:<edge>vacation.<prop>vacation_type.<value>value: ["事假", "病假", "年假", "产假"]
    <output>:<node>vacation-requirement:<edge>vacation.<prop>reason.<type>type: "文本"
    <output>:<node>vacation-requirement:<edge>vacation.<prop>time.<type>type: "文本"
    <output>:<node>vacation-requirement:<prop>sign.<type>type: "文本"
}
信息数据来源：
1、
{
